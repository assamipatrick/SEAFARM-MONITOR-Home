...
export const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        // FIX: Added Payroll Calculator to navigation
        { label: { en: 'Payroll Calculator', fr: 'Calculateur de paie' }, path: '/payroll-calculator', icon: 'Calculator', permission: PERMISSIONS.PAYROLL_MANAGE },
      ]
    },
    {
      ...
      children: [
        ...
        // FIX: Added Photo Gallery to navigation
